            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="form-row">
                        ...
                        <input type="email" class="form-control" id="inputEmail4" placeholder="dosmildiez@gmail.com" readonly>
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="inputAddress">Nombre</label>
                        <input type="text" class="form-control" id="inputAddress" placeholder="Jose Moreno Navarro" readonly>
                    </div>
